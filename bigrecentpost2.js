function renderRecentVerticalPosts(json) {
    ...
    for (var i = 0; i < 3; i++) {
        if (entries[i]) {
            ...
            // Main logic to fix image resolution
            var originalThumb = post.media$thumbnail ? post.media$thumbnail.url : 'https://via.placeholder.com/1200x630';
            
            /* Replaces small thumbnail parameters (like s72-c or w72-h72) 
               with s1600 (Blogger's high-res/original size)
            */
            ...
            // Generates a 60-word snippet from post content
