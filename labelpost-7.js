/* * Name: labelpost-6
 * Function: Dual Column Layout (Left: Numbered List, Right: Featured Grid)
 */
...
function labelpost_6(json) {
    ...
    // --- देब्रे कोलम: हेडलाइन्स लिस्ट (१० वटा सम्म) ---
    ...
    for (let i = 0; i < entries.length; i++) {
        ...
        leftListHtml += `<li><span class="lp6-number">${i + 1}</span><a href="${link}">${title}</a></li>`;
    }
    leftListHtml += `</ul></div>`;
